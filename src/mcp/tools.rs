    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter to a page region (main, nav, header, footer, aside, content, form, dialog), element role (button, link, text_input, select, etc.), action surface (interactive, action:click, action:type, action:select), text/label query (text:checkout, label:email), common locator attribute ([data-testid=save], input[name=q], [required]), or #element-id. Strips irrelevant regions/elements to reduce tokens."
                }
            },
            "required": ["url"]
        }),
    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter before extracting text: page region (main, nav, header, footer, aside, content, form, dialog), element role (button, link, text_input, select, etc.), action surface (interactive, action:click, action:type, action:select), text/label query (text:checkout, label:email), common locator attribute ([data-testid=save], input[name=q], [required]), or #element-id."
                }
            },
            "required": ["url"]
        }),
    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter before extracting links: page region (main, nav, header, footer, aside, content, form, dialog), element role (link), action surface (interactive, action:click), text/label query, common locator attribute, or #element-id."
                }
            },
            "required": ["url"]
        }),
