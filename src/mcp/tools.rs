    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter to a page region (main, nav, header, footer, aside, content, form, dialog), element role (button, link, text_input, select, etc.), action surface (interactive, action:click, action:type, action:select), label/text query (label:Save, text:Welcome), common attribute selector ([name=q], [data-testid=save], input[type=search]), or #element-id. Strips irrelevant regions/elements to reduce tokens."
                }
            },
            "required": ["url"]
        }),
    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter before extracting text: page region (main, nav, header, footer, aside, content, form, dialog), element role (button, link, text_input, select, etc.), action surface (interactive, action:click, action:type, action:select), label/text query, common attribute selector, or #element-id."
                }
            },
            "required": ["url"]
        }),
