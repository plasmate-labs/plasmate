    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter to a page region (main, nav, header, footer, aside, content, form, dialog), element role (button, link, text_input, select, etc.), action surface (interactive, action:click, action:type, action:select), text anchor (text:, label:, placeholder:, description:), locator/attribute selector ([data-testid=save], [name=q], input[type=search], [required]), or #element-id. Strips irrelevant regions/elements to reduce tokens."
                }
            },
            "required": ["url"]
        }),
    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter before extracting text: page region, element role, action surface, text anchor (text:, label:, placeholder:, description:), locator/attribute selector, or #element-id."
                }
            },
            "required": ["url"]
        }),
    ...
    ToolDefinition {
        ...
        input_schema: json!({
            ...
            "properties": {
                ...
                "selector": {
                    "type": "string",
                    "description": "Filter before extracting links: page region, link/action selector, text anchor (text:, label:, description:), locator/attribute selector, or #element-id."
                }
            },
            "required": ["url"]
        }),
