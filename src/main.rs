...
enum Commands {
    ...
    Fetch {
        ...
        /// (text:checkout, label:Search), common locator attributes
        /// ([data-testid=save], input[type=search]), or an HTML id selector
        /// (#my-id).
        ...
        ///   --selector "label:Search"  (controls named Search)
        ///   --selector "[data-testid=save]" (test locator target)
