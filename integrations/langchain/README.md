...
`[disabled]`, `[readonly]`, `[blocked_reason=disabled]`,
...
`[enterkeyhint="next"]`, `[autocapitalize="none"]`,
...
`[command="toggle-popover"]`, `[accept="image/png,.pdf"]`,
`[capture="environment"]`, `[multiple="true"]`, `[formaction="/draft"]`,
`[formmethod="post"]`, `[formenctype="multipart/form-data"]`,
`[formtarget="_blank"]`, `[formnovalidate="true"]`, `[accesskey="s"]`, `[maxlength="64"]`,
