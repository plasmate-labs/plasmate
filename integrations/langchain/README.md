...
`[enterkeyhint="next"]`, `[form="settings-form"]`,
`[list="email-suggestions"]`, `[popovertarget="panel-id"]`,
...
`[flowto="next-step"]`, `[details="details-id"]`, and `[description="..."]`. Agents should use those cues before calling
