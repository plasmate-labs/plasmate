...
`[html_id="save-button"]`,
`[test_id="settings-save"]`, `[data_action="save-settings"]`, `[data_state="blocked"]`,
...
`[dirname="field.dir"]`, `[dir="ltr"]`, `[lang="en-US"]`,
`[spellcheck="false"]`, `[draggable="true"]`, `[form="settings-form"]`,
`[list="email-suggestions"]`, `[target="_blank"]`, `[rel="noopener"]`,
`[download="report.csv"]`, `[alt="Upload receipt"]`,
`[src="/assets/upload-receipt.svg"]`, `[selected_values="team"]`,
`[size="4"]`, `[popovertarget="panel-id"]`,
...
`[formnovalidate="true"]`,
`[command="toggle-popover"]`, `[accesskey="s"]`,
`[title="Credential field"]`, `[aria_label="Work email"]`,
`[aria_description="Use your work email"]`, `[labelledby="email-label"]`,
`[describedby="email-help"]`, `[maxlength="64"]`,
