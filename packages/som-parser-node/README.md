...
// Compact action targets with id, cache_key, role, actions, enabled, and labels.
...
| `getActionPlan(som): ActionPlanItem[]` | Return compact action targets with cache keys, availability, and live state cues for agent planning. |
